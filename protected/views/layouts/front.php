			...
			<div class="container">
              ...
              <?php $this->widget('zii.widgets.CMenu',array(
                'encodeLabel' => false,
                  ...
                  array('label'=>'Images', 'url'=>array('/gtest/Pic')),
                  ...
                  array('label'=>'<span>Login</span>', 'url'=>array('/glogin/Log'),'itemOptions'=> array('class' => 'btn-cta','id' => 'loginbtn','data-toggle' => 'modal','data-target' => '#myModal'),),
							...
							<!-- <li class="btn-cta" id="<?php echo Yii::app()->request->baseUrl; ?>/images/img_bg_1.jpg"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/gtest/Log"><span>Login</span></a></li>
...
<!-- <?php echo $content; ?> -->
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/try.jpg);">
	...
	<div id="fh5co-consult">
		...
		<div class="choose animate-box">
			...
			<form action="" name="Gmsg" id="Gmsg" method="post">
				...
				<div class="row form-group">
					<div class="col-md-12">
						...
						<textarea name="qury" id="qury" cols="30" rows="10" class="form-control" placeholder="Say something about us"></textarea>
					</div>
				</div>
				<div class="form-group">
					<input type="submit" name="sb" value="Send Message" class="btn btn-primary">
				</div>
...
<!-- modal end  -->
	...
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/magnific-popup-options.js"></script>
